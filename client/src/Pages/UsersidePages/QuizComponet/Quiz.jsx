...
const QuizComponent = () => {
  ...
  return (
    <div className="quiz-wrapper" style={{ backgroundImage: `url(${backgroundImg})` }}>
      {/* HEADER */}
      ...
      {loading ? (
        ...
        <div className="quiz-congrats">
          ...
          <p className="score">Score : {score * 10} / {questions.length * 10}</p>
        ...
        <div className="quiz-question-box">
          ...
          <button className="quiz-next-btn" onClick={handleNext} disabled={!selectedOption}>
            Next
          </button>
        </div>
      )}
